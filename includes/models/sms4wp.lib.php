...
function sms4wp_view_configure() {
    ...
    // print_r( $sms4wp_config );

    require_once( SMS4WP_INC_MODEL_PATH . '/sms4wp.control.php' );
    $sms4wp_data = sms4wp_prepare_data();
    // print_r( $sms4wp_data );
    // echo $sms4wp_data['today_send'];
    // echo $sms4wp_data['point'];
    // echo $sms4wp_data['sms_cost'];
    // echo $sms4wp_data['lms_cost'];
    // echo $sms4wp_data['mms_cost'];
...
function sms4wp_view_group() {
    ...
    // include_once( ABSPATH . 'wp-admin/edit-tags.php?taxonomy=sms4wp' );
} 
